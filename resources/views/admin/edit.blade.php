    ...
    <div class="col-lg-8">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-secondary fw-semibold" aria-current="page">Edit Merchandise</li>
            </ol>
        </nav>
        ...
        <div class="card border-0 rounded-4 shadow-sm overflow-hidden mb-5">
            ...
            <div class="card-header bg-dark text-white py-4 px-4 border-0">
                <div class="d-flex align-items-center gap-3">
                    <div class="bg-primary bg-opacity-25 rounded-3 p-2 text-primary-light">
                        <i class="fa-solid fa-pen-to-square fs-3 text-white"></i>
                    </div>
                    <div>
                        <h4 class="mb-0 fw-bold font-heading">Edit Merchandise</h4>
                        <p class="mb-0 text-white-50 small">Ubah informasi detail data barang merchandise pada form di bawah ini.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-4 p-md-5 bg-white">
                <form action="{{ route('admin.merchandise.update', $merchandise->id_barang) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('nama_barang', $merchandise->nama_barang) }}" 
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('event_terkait', $merchandise->event_terkait) }}" 
                                   placeholder="Nama event yang berhubungan" 
                                   required>
                            @error('event_terkait')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <!-- Stok -->
                        <div class="col-md-6">
                            <label for="stok" class="form-label fw-semibold text-secondary small">Stok Barang <span class="text-danger">*</span></label>
                            <input type="number" 
                                   name="stok" 
                                   id="stok" 
                        ...
                        <!-- Foto / Gambar Saat Ini & Form Upload Baru -->
                        <div class="col-12">
                            <label class="form-label fw-semibold text-secondary small d-block">Foto Saat Ini</label>
                            <div class="mb-3">
                                @if($merchandise->gambar)
                                    <div class="p-2 border rounded-3 bg-light d-inline-block">
                                        <img src="{{ asset($merchandise->gambar) }}" class="object-fit-cover rounded-2" style="width: 150px; height: 150px;" alt="{{ $merchandise->nama_barang }}">
                                    </div>
                                @else
                            ...
                            <label for="gambar" class="form-label fw-semibold text-secondary small">Ganti Foto Baru (Opsional)</label>
                            <input type="file" 
                                   name="gambar" 
                                   id="gambar" 
                                   class="form-control bg-light @error('gambar') is-invalid @enderror" 
                                   accept="image/*">
                            <div class="form-text text-muted small">Biarkan kosong jika tidak ingin mengubah foto. Format yang didukung: JPEG, PNG, JPG, GIF. Ukuran maksimum: 2MB.</div>
                            @error('gambar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
